...
namespace Unit05.Game.Casting
{
    ...
    public class PlayerTwo: Actor
    {
        ...
        /// <summary>
        /// Constructs a new instance of Player Two.
        /// </summary>
        public PlayerTwo()
        {
            PrepareBody();
        ...
        /// <summary>
        /// Gets the Player Two segments (including the first).
        /// </summary>
        /// <returns>A list of Player Two segments as instances of Actors.</returns>
        ...
        /// <summary>
        /// Turns the Player Two's first segment in the given direction.
        /// </summary>
        ...
        private void PrepareBody()
        {
            ...
            for (int i = 0; i < Constants.SNAKE_LENGTH; i++)
            {
                ...
                string text = i == 0 ? "8" : "#";
                Color color = i == 0 ? Constants.YELLOW : Constants.BLUE;
